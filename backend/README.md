...
## Project Structure
    ...
    ├── testapiautosetting_125927  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125927`
...
2. Clone this repo and `cd testapiautosetting_125927`
